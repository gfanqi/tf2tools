...
#
#     h = np.linspace(h_range[0], h_range[1], endpoint=True, num=10)
#     s = np.linspace(s_range[0], s_range[1], endpoint=True, num=10)
#     v = np.linspace(v_range[0], v_range[1], endpoint=True, num=10)
...
#
#     center = (255, 255, 255)
#     x = center[0] + s * np.sin(-h / 180 * np.pi)
#     y = center[1] + s * np.cos(h / 180 * np.pi)
#     z = (v)
#     x = x.astype(np.int)
#     y = y.astype(np.int)
#     z = z.astype(np.int)
